      ...
      <div className="p-4 min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          {/* <div className="bg-pink-500 text-white p-4 rounded-2xl shadow">
            <p className="text-lg">Tỉ lệ tương tác</p>
            <p className="text-4xl font-bold">
              {totalEngagementRate.toFixed(1)}%
            </p>
          </div> */}
        </div>
        ...
        {/* <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="bg-white p-6 rounded-2xl shadow">
            <h2 className="text-xl font-semibold mb-4">
              Hiệu suất bài đăng theo thời gian
            </h2>
            <div className="h-64 flex items-center justify-center opacity-50">
              <p>Biểu đồ đường (placeholder)</p>
            </div>
          </div>
